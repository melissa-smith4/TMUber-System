...
public class User 
{
  ...
  //Decrement the amount of rides a user has
  public void removeRide(){
    this.rides --;
  }
  //Decrement the amount of deliveries a user has
  ...
  {
    //Cast object to User and check if the name and address for this and other match
    User otherUser = (User) other;
    return this.getName().equals(otherUser.getName()) && this.getAddress().equals(otherUser.getAddress());
  }
}

...
public class TMUberDelivery extends TMUberService
{
  ...
  public boolean equals(Object other)
  {
    ...
    if (otherService.getServiceType() != "DELIVERY"){
      return false;
    }
    // If other is delivery, cast to TMUDelivery type and check to see if this and other are equal
    TMUberDelivery otherDeliv = (TMUberDelivery) other;
    return super.equals(other) && this.getRestaurant().equalsIgnoreCase(otherDeliv.getRestaurant()) && this.getFoodOrderId().equals(otherDeliv.getFoodOrderId());
  }
  /*
